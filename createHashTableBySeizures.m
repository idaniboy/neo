...
%             nthSeizure
        ...
        [~,~,~,channels]=sParLoad(strcat(clipLoc,filesep,clipDirNames{nthDir},'_ictal_concatenated_',num2str(1),'.mat'));
        save_hashes(H,clipLoc,clipDirNames{nthDir},length(fieldnames(channels)));
        nthDir
